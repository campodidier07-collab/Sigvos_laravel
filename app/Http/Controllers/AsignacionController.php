...
class AsignacionController extends Controller
{
    ...
    {
        // Solo obtener usuarios que tengan rol de trabajador o que tengan actividades asignadas
        $usuarios = Usuario::with(['actividadesAsignadas' => function($query) {
        ...
        $trabajadores = $usuarios->filter(function($user) {
            return $user->esTrabajador() || $user->actividadesAsignadas->count() > 0;
        });
