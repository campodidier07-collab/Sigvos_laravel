...
@section('page-title', 'Registrar Nuevo Lote')
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <small class="form-text text-muted">Una sola letra (A, B, C...)</small>
                @error('identificador')
            ...
            <div class="col-md-8">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('nombre') is-invalid @enderror" 
                       ...
                       placeholder="Ej. Lote Principal" required>
                @error('nombre')
                  <span class="invalid-feedback">{{ $message }}</span>
                @enderror
              </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('ubicacion') is-invalid @enderror" 
                   ...
                   placeholder="Ej. Finca el Paraíso, Sector Norte" required>
            @error('ubicacion')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="number" step="0.01" min="0.01" class="form-control @error('area_ha') is-invalid @enderror" 
                         id="area_ha" name="area_ha" value="{{ old('area_ha') }}" required>
          ...
          <div class="form-group mb-0">
            <div class="custom-control custom-switch">
              <input type="checkbox" class="custom-control-input" id="es_alternativo" name="es_alternativo" value="1" {{ old('es_alternativo') ? 'checked' : '' }}>
              <label class="custom-control-label" for="es_alternativo">Marcar como lote alternativo</label>
              <small class="form-text text-muted d-block">Los lotes alternativos se usan para rotación o descansos.</small>
            </div>
          </div>
